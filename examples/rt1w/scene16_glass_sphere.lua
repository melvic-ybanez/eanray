...
-- ground
objects:add(Sphere:stationary(Point:new(0, -100.5, -1), 100, Lambertian:from_albedo(Color:new(0.8, 0.8, 0))))

-- center (slightly further)
objects:add(Sphere:stationary(Point:new(0, 0, -1.2), 0.5, Lambertian:from_albedo(Color:new(0.1, 0.2, 0.5))))
