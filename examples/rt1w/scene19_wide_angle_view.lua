...
objects:add_all(
    Sphere:stationary(Point:new(-radius, 0, -1), radius, Lambertian:from_albedo(Color:new(0, 0, 1))),
    Sphere:stationary(Point:new(radius, 0, -1), radius, Lambertian:from_albedo(Color:new(1, 0, 0)))
)
