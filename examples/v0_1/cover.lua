...
local function make_ground()
  local radius = 1000
  local ground = Sphere:new(Point:new(0, -radius, 0), radius, Lambertian:new(Color:new(0.76, 0.70, 0.50)))
  objects:add(ground)
end
...
local function make_group()
  ...
  local z = 2.5
  objects:add(Sphere:new(Point:new(3, base_radius, z), base_radius, Metal:new(Color:new(1, 0.5, 0.5), 0)))
  objects:add(Sphere:new(Point:new(3, base_radius * 2 + head_radius, z), head_radius, Dielectric:new(Dielectric.RefractiveIndex.GLASS)))
end
...
objects:add(Sphere:new(Point:new(5.6, 0.2, 2.7), 0.2, Lambertian:new(Color.random() * Color.random())))

objects:add(Sphere:new(Point:new(5.7, small_radius, 1), small_radius, Dielectric:new(Dielectric.RefractiveIndex.GLASS)))
