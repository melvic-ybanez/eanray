...
-- ground
objects:add(Sphere:new(Point:new(0, -100.5, -1), 100, Lambertian:new(Color:new(0.8, 0.8, 0))))

-- center (slightly further)
objects:add(Sphere:new(Point:new(0, 0, -1.2), 0.5, Lambertian:new(Color:new(0.1, 0.2, 0.5))))

-- left
objects:add(Sphere:new(Point:new(-1, 0, -1), 0.5, Dielectric:new(Dielectric.RefractiveIndex.GLASS)))

-- right
objects:add(Sphere:new(Point:new(1, 0, -1), 0.5, Metal:new(Color:new(0.8, 0.6, 0.2), 1)))
