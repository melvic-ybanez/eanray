...
impl<K> VecLike<K> {
    ...
    pub(crate) fn from_scalar(scalar: Real) -> Self {
    ...
    pub(crate) fn random_range(min: Real, max: Real) -> VecLike<K> {
        VecLike::new(
...
impl Vec3D {
    pub(crate) fn length(&self) -> Real {
        self.length_squared().sqrt()
    }

    pub(crate) fn length_squared(&self) -> Real {
        self.dot(self)
    }

    pub(crate) fn dot(&self, rhs: &Vec3D) -> Real {
        self.x * rhs.x + self.y * rhs.y + self.z * rhs.z
    }

    pub(crate) fn cross(&self, rhs: &Vec3D) -> Self {
        Self::new(
    ...
    pub(crate) fn to_unit(&self) -> UnitVec3D {
        UnitVec3D(self / self.length())
    }

    pub(crate) fn random_on_hemisphere(normal: &UnitVec3D) -> UnitVec3D {
    ...
    pub(crate) fn reflect(&self, normal: &UnitVec3D) -> Vec3D {
    ...
    /// is zero)
    pub(crate) fn random_in_unit_disk() -> Vec3D {
        loop {
            let v = Vec3D::new(
